...
import OrderSummary from "@/components/OrderSmmary";
import AddressSelectionModal from "@/components/AddressSelectionModel";
...
const CartScreen = () => {
  ...
  const handleCheckout = () => {
    ...
    if (!process.env.EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY) {
      Alert.alert(
        ...
        "Add EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY to mobile/.env and restart Expo to enable checkout.",
        [{ text: "OK" }]
      );
      return;
    }
  ...
  const handleProceedWithPayment = async (selectedAddress: Address) => {
    ...
    const zipCode = selectedAddress.zipCode ?? (selectedAddress as Address & { zipcode?: string }).zipcode;
