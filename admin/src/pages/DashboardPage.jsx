...
import { customerApi, orderApi, statsApi } from "../libs/api";
...
function DashboardPage() {
  ...
  const statsCards = [
    ...
    {
      name: "Total Orders",
      value: statsLoading ? "..." : statsError ? "Error" : statsData?.totalOrders || 0,
      icon: <ShoppingBagIcon className="size-8" />,
    },
    {
      name: "Total Customers",
      value: customersLoading ? "..." : customersError ? "Error" : customersData?.length || 0,
      icon: <UsersIcon className="size-8" />,
    },
    {
      name: "Total Products",
      value: statsLoading ? "..." : statsError ? "Error" : statsData?.totalProducts || 0,
